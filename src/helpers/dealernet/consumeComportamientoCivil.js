...
const ConsumeSoapComportamientoCivil = async (rut) => {
    ...
    <prods>
    <prod cod="3401" gls="Comportamiento Civil" />
    </prods>
    </root>
    </web:input>
    </web:CentralDeInformacion>
    ...
    // switch (rut) {
    //     case '15670634-5':
    //         data = fs.readFileSync('ortegaeduardocivil.xml', 'utf8');
    //         break;
    //     case '17546853-6':
    //         data = fs.readFileSync('romeromiguelcivil.xml', 'utf8');
    //         break;
    //     case '17324250-6':
    //         data = fs.readFileSync('pazyorcivil.xml', 'utf8');
    //         break;
    //     default:
...
module.exports = ConsumeSoapComportamientoCivil;